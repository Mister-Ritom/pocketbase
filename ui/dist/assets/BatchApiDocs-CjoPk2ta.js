import{S as Lt,i as St,s as At,ai as Mt,aj as Ht,L as Y,h as d,d as Re,t as Z,a as x,I as jt,M as Pt,N as Nt,C as Ut,P as Jt,D as zt,l as u,n as t,m as Te,E as Gt,G as Kt,u as a,A as _,v as i,c as Pe,w as b,J as Ft,p as Wt,k as ee,o as Qt}from"./index-BXdnPgBO.js";function Bt(o,s,n){const c=o.slice();return c[6]=s[n],c}function Et(o,s,n){const c=o.slice();return c[6]=s[n],c}function Ot(o,s){let n,c,y;function f(){return s[5](s[6])}return{key:o,first:null,c(){n=a("button"),n.textContent=`${s[6].code} `,b(n,"class","tab-item"),ee(n,"active",s[1]===s[6].code),this.first=n},m(r,h){u(r,n,h),c||(y=Qt(n,"click",f),c=!0)},p(r,h){s=r,h&10&&ee(n,"active",s[1]===s[6].code)},d(r){r&&d(n),c=!1,y()}}}function It(o,s){let n,c,y,f;return c=new Ht({props:{content:s[6].body}}),{key:o,first:null,c(){n=a("div"),Pe(c.$$.fragment),y=i(),b(n,"class","tab-item"),ee(n,"active",s[1]===s[6].code),this.first=n},m(r,h){u(r,n,h),Te(c,n,null),t(n,y),f=!0},p(r,h){s=r,(!f||h&10)&&ee(n,"active",s[1]===s[6].code)},i(r){f||(x(c.$$.fragment,r),f=!0)},o(r){Z(c.$$.fragment,r),f=!1},d(r){r&&d(n),Re(c)}}}function Vt(o){var pt,mt,bt,ht,ft,_t,yt,kt;let s,n,c=o[0].name+"",y,f,r,h,F,g,U,Fe,P,B,Be,E,Ee,Oe,te,le,w,ae,O,oe,I,se,H,ne,J,ie,q,ce,Ie,re,L,z,He,k,G,Le,de,Se,D,K,Ae,ue,Me,W,je,pe,Ne,C,Ue,me,Je,ze,Ge,Q,Ke,V,We,be,Qe,he,Ve,fe,Xe,p,_e,Ye,ye,Ze,ke,xe,$e,et,ge,tt,ve,lt,at,ot,De,st,R,Ce,S,we,T,A,v=[],nt=new Map,it,M,$=[],ct=new Map,j,qe,rt;w=new Mt({props:{js:`
    ...
    `}}),R=new Ht({props:{language:"javascript",content:`
            ...
            `),E=a("a"),E.textContent="Dashboard settings",Ee=_("."),Oe=i(),te=a("p"),te.innerHTML=`Because this endpoint process the requests in a single DB transaction it could degrade the
            ...
            <em>(prefer smaller max processing and body size limits, avoid large file uploads over slow S3
                networks and custom hooks that communicate with slow external APIs)</em>.`,le=i(),Pe(w.$$.fragment),ae=i(),O=a("h6"),O.textContent="API details",oe=i(),I=a("div"),I.innerHTML='<strong class="label label-primary">POST</strong> <div class="content">/api/batch</div>',se=i(),H=a("div"),H.textContent="Body Parameters",ne=i(),J=a("p"),J.innerHTML=`Body parameters could be sent as <em>application/json</em> or <em>multipart/form-data</em>.
    <br/>
    File upload is supported only via <em>multipart/form-data</em> (see below for more details).`,ie=i(),q=a("table"),ce=a("thead"),ce.innerHTML='<tr><th>Param</th> <th width="80%">Description</th></tr>',Ie=i(),re=a("tbody"),L=a("tr"),z=a("td"),z.innerHTML='<div class="flex txt-nowrap"><span class="label label-success">Required</span> <span>requests</span></div>',He=i(),k=a("td"),G=a("span"),G.textContent="Array<Request>",Le=_(` - List of the requests to process.

                `),de=a("p"),de.textContent="The supported batch request actions are:",Se=i(),D=a("ul"),K=a("li"),Ae=_("record create - "),ue=a("code"),ue.textContent="POST /api/collections/{collection}/records",Me=i(),W=a("li"),je=_(`record update -
                        `),pe=a("code"),pe.textContent="PATCH /api/collections/{collection}/records/{id}",Ne=i(),C=a("li"),Ue=_("record upsert - "),me=a("code"),me.textContent="PUT /api/collections/{collection}/records",Je=i(),ze=a("br"),Ge=i(),Q=a("small"),Q.innerHTML='(the body must have <code class="txt-sm">id</code> field)',Ke=i(),V=a("li"),We=_(`record delete -
                    ...
                    `,lt=_(`.
                    `),at=a("br"),ot=_(`
                    If you don't use the SDKs or prefer manually to construct the `),De=a("code"),De.textContent="FormData",st=_(`
                    body, then it could look something like:
                    `),Pe(R.$$.fragment),Ce=i(),S=a("div"),S.textContent="Responses",we=i(),T=a("div"),A=a("div");for(let e=0;e<v.length;e+=1)v[e].c();it=i(),M=a("div");for(let e=0;e<$.length;e+=1)$[e].c();b(s,"class","m-b-sm"),b(h,"class","content txt-lg m-b-sm"),b(U,"class","icon"),b(E,"href","/settings"),b(P,"class","content"),b(g,"class","alert alert-warning"),b(O,"class","m-b-xs"),b(I,"class","api-route alert alert-success"),b(H,"class","section-title"),b(z,"valign","top"),b(G,"class","label"),b(Q,"class","txt-hint"),b(q,"class","table-compact table-border m-t-xs m-b-base"),b(S,"class","section-title"),b(A,"class","tabs-header compact combined left"),b(M,"class","tabs-content"),b(T,"class","tabs")},m(e,l){u(e,s,l),t(s,n),t(s,y),t(s,f),u(e,r,l),u(e,h,l),u(e,F,l),u(e,g,l),t(g,U),t(g,Fe),t(g,P),t(P,B),t(B,Be),t(B,E),t(B,Ee),t(P,Oe),t(P,te),u(e,le,l),Te(w,e,l),u(e,ae,l),u(e,O,l),u(e,oe,l),u(e,I,l),u(e,se,l),u(e,H,l),u(e,ne,l),u(e,J,l),u(e,ie,l),u(e,q,l),t(q,ce),t(q,Ie),t(q,re),t(re,L),t(L,z),t(L,He),t(L,k),t(k,G),t(k,Le),t(k,de),t(k,Se),t(k,D),t(D,K),t(K,Ae),t(K,ue),t(D,Me),t(D,W),t(W,je),t(W,pe),t(D,Ne),t(D,C),t(C,Ue),t(C,me),t(C,Je),t(C,ze),t(C,Ge),t(C,Q),t(D,Ke),t(D,V),t(V,We),t(V,be),t(k,Qe),t(k,he),t(k,Ve),t(k,fe),t(k,Xe),t(k,p),t(p,_e),t(p,Ye),t(p,ye),t(p,Ze),t(p,ke),t(p,xe),t(p,$e),t(p,et),t(p,ge),t(p,tt),t(p,ve),t(p,lt),t(p,at),t(p,ot),t(p,De),t(p,st),Te(R,p,null),u(e,Ce,l),u(e,S,l),u(e,we,l),u(e,T,l),t(T,A);for(let m=0;m<v.length;m+=1)v[m]&&v[m].m(A,null);t(T,it),t(T,M);for(let m=0;m<$.length;m+=1)$[m]&&$[m].m(M,null);j=!0,qe||(rt=Gt(Kt.call(null,E)),qe=!0)},p(e,[l]){var gt,vt,Dt,Ct,wt,qt,Rt,Tt;(!j||l&1)&&c!==(c=e[0].name+"")&&jt(y,c);const m={};l&5&&(m.js=`
        import PocketBase from 'pocketbase';
    ...
    `),w.$set(m);const $t={};l&1&&($t.content=`
                            ...
                            // file for the second request
                            formData.append("requests.1.someFileField", new File(...))
                        `),R.$set($t),l&10&&(X=Y(e[3]),v=Pt(v,l,dt,1,e,X,nt,A,Nt,Ot,null,Et)),l&10&&(N=Y(e[3]),Ut(),$=Pt($,l,ut,1,e,N,ct,M,Jt,It,null,Bt),zt())},i(e){if(!j){x(w.$$.fragment,e),x(R.$$.fragment,e);for(let l=0;l<N.length;l+=1)x($[l]);j=!0}},o(e){Z(w.$$.fragment,e),Z(R.$$.fragment,e);for(let l=0;l<$.length;l+=1)Z($[l]);j=!1},d(e){e&&(d(s),d(r),d(h),d(F),d(g),d(le),d(ae),d(O),d(oe),d(I),d(se),d(H),d(ne),d(J),d(ie),d(q),d(Ce),d(S),d(we),d(T)),Re(w,e),Re(R);for(let l=0;l<v.length;l+=1)v[l].d();for(let l=0;l<$.length;l+=1)$[l].d();qe=!1,rt()}}}function Xt(o,s,n){let c,y,{collection:f}=s,r=200,h=[];const F=g=>n(1,r=g.code);return o.$$set=g=>{"collection"in g&&n(0,f=g.collection)},o.$$.update=()=>{o.$$.dirty&1&&n(4,y=Ft.dummyCollectionRecord(f)),o.$$.dirty&17&&f!=null&&f.id&&(h.push({code:200,body:JSON.stringify([{status:200,body:y},{status:200,body:Object.assign({},y,{id:y.id+"2"})}],null,2)}),h.push({code:400,body:`
                {
                  "status": 400,
            ...
            `}))},n(2,c=Ft.getApiExampleUrl(Wt.baseURL)),[f,r,c,h,y,F]}class Zt extends Lt{constructor(s){super(),St(this,s,Xt,Vt,At,{collection:0})}}export{Zt as default};
